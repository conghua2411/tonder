...
class PassPartnerBloc extends BaseBloc {

  final BehaviorSubject<List<Partner>> _listPartner = BehaviorSubject();

  final PartnerRepo _partnerRepo;

  PassPartnerBloc(this._partnerRepo);

  Future<bool> init() {
    return getListPassPartner().then((value) {
  ...
  Future<List<Partner>> getListPassPartner() => _partnerRepo.getPass();
